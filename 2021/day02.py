...
def problem_one(vals):
    ...
    for val in vals:
        func = tokens.get(val[0])
        increment_x, increment_y = func(int(val[1]))
        depths = depths[0] + increment_x, depths[1] + increment_y
...
def problem_two(vals):
    tokens = {
        'forward': lambda x, a: (x, x * a, 0),
        'down': lambda x, a: (0, 0, x),
        'up': lambda x, a: (0, 0, -x)
    }
    depths = (0, 0, 0)
    ...
    for val in vals:
        func = tokens.get(val[0])
        x, y, aim = depths
        increment_x, increment_y, increment_aim = func(int(val[1]), aim)
        depths = x + increment_x, y + increment_y, aim + increment_aim
